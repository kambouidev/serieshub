...
const SHSearchBar = () => {
    ...
    return (
        <div className="searchContainer  sm:p-4 md:p-6 lg:p-8 xl:p-10 flex rounded-[10px] justify-center p-2 bg-greyIsh relative bg-opacity-40">
            <div className='searchBarContainer p-2 sm:p-4 md:p-6 lg:p-8 xl:p-10 flex flex-col justify-between items-center rounded-[8px] gap-[10px] bg-backgroundColor shadow-2xl w-[70%] min-w-[200px] '>
                <div className="flex gap-4 items-center w-[100%] relative">
                    ...
                    <div className='inputWrapper flex flex-col w-full relative'>
                        ...
                        {showRecentSearches && (
                            <div className="absolute left-0 w-full top-[30px] bg-white bg-opacity-80 rounded-b-md">
