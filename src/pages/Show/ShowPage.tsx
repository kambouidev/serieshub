...
const ShowPage = () => {
    ...
    const seasonsData = _embedded.seasons.map(({ id, image, name, number, premiereDate, episodeOrder }) => (
        {
            id: id,
            image: image && image.original ? image.original : no_image,
            ...
            {data &&
                <div className="gap-2">
                    ...
                    <div>
                        ...
                        {seasonsData.map((season) => <SHCard data={season} />)}
